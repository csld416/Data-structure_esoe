...
BinaryTreeNode<K, V>::BinaryTreeNode(Entry<K, V>* e)
    : entry(e), parent(NULL), leftChild(NULL), rightChild(NULL) {}

/** Simple constructor that sets the entry and parent.
 *  The rest of the fields are set to null. */
template <typename K, typename V>
BinaryTreeNode<K, V>::BinaryTreeNode(Entry<K, V>* e, BinaryTreeNode<K, V>* p)
    : entry(e), parent(p), leftChild(NULL), rightChild(NULL) {}

/** Simple constructor that sets all of the node's fields. */
template <typename K, typename V>
BinaryTreeNode<K, V>::BinaryTreeNode(Entry<K, V>* e, BinaryTreeNode<K, V>* p,
                                     BinaryTreeNode<K, V>* l, BinaryTreeNode<K, V>* r)
